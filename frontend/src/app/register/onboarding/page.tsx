...
export const metadata = {
  title: 'ReviewAI - Personalize Your Experience',
  description: 'Complete your setup and personalize your code review experience.',
};

function ReviewAILogo() {
  return (
...
export default function RegisterOnboardingPage() {
  return (
    <div className="bg-background-dark font-display text-white min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
